 ...
 * loop. That is, it implements the Iterable<TYPE> interface by simply returning
 * itself. For example, this allows one to write for (int[] e: G.edges()) { ...
 * }
 *
 * @author P. N. Hilfinger
 */
public abstract class Iteration<Type> implements
        Iterator<Type>, Iterable<Type> {
    ...
    /** A wrapper class that turns an Iterator<TYPE>
     *  into an Iteration<TYPE>. */
